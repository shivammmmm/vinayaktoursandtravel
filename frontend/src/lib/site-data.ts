...
export const regions: { key: string; label: string; destinations: Dest[] }[] = [
  {
    ...
    destinations: [
      ...
      { name: "Char Dham Yatra", slug: "char-dham", image: "/chardham-yatra-custom.jpg", blurb: "Yamunotri, Gangotri, Kedarnath, Badrinath.", from: "₹ 24,999" },
  ...
  },
  {
    ...
    destinations: [
      ...
      { name: "Egypt", slug: "egypt", image: img("photo-1503177119275-0aa32b3a9368"), blurb: "Pyramids, Nile cruises and Red Sea reefs." },
  ...
  },
  {
    ...
    destinations: [
      ...
      { name: "Chile", slug: "chile", image: img("photo-1469854523086-cc02fe5d8800"), blurb: "Atacama desert and Torres del Paine." },
      { name: "Uruguay", slug: "uruguay", image: img("photo-1590001155093-a3c66ab0c3ff"), blurb: "Montevideo and Punta del Este." },
    ],
  },
  {
